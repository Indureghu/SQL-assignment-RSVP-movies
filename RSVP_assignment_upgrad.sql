...
-- Type your code below:
select year,count(id) as num_of_movies
From movie
...
select count(movie_id) as num_of_onegenre_mov
from one_genre;
...
from names n inner join director_mapping dm on
n.id=dm.name_id inner join genre g on
